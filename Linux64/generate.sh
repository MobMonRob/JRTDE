...
gcc -shared -fPIC -cpp -std=c++17 -O3 -flto ../swig/rtde_wrap.cpp -Lbuild  -I/usr/lib/jvm/default-java/include -I/usr/lib/jvm/default-java/include/linux -Wl,-rpath,'$ORIGIN/.'
